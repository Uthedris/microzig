...
pub const startup_logic = struct {
    ...
    /// and is used to dispatch interrupts to the appropriate handler.
    ...
    /// This is called to service a machine external interrupt.  These are the
    /// interrupts that are generated by the various I/O devices.
